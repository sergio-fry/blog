...
Тимлид с 2017 года, спикер, профессиональный разработчик с 2006 года. Управляю тремя продуктовыми командами в ecom.tech, отвечаю за процесс разработки и управление людьми в них.
...
*Управление Выработка архитектурных решений, кодревью, найм, развитие сотрудников. Навыки: Ruby, GraphQL, Kafka, PostgreSQL, Gitlab CI, Docker*
