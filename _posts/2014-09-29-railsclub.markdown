...
description: На этих выходных сходил с коллегами из SeoPult на ежегодную конференцию RailsClub 2014. Встретил много друзей, с которыми работали вместе в других компаниях. Еще я выиграл приз.
---
